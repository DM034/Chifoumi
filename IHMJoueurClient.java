...
public class IHMJoueurClient extends Box implements ActionListener, Observer {
  ...
  private JButton ciseauxM = new JButton(new ImageIcon("ciseau.png"));
  ...
  private JButton ciseauxA = new JButton(new ImageIcon("ciseau.png"));
  ...
  public void actionPerformed(ActionEvent evt) {
    ...
    joueur.out.println(
      Constantes.CHOIX + " " + boutonChoisi.getActionCommand()
    );
  ...
  public void indiquerChoixAdversaire() {
    ...
    if ((joueur.choix != null) && (choixAdversaire != null)) {
      if (choixAdversaire == Choix.FEUILLE) boutonChoixAdversaire =
        feuilleA; else if (
        choixAdversaire == Choix.CISEAUX
      ) boutonChoixAdversaire = ciseauxA; else if (
        choixAdversaire == Choix.CAILLOU
      ) boutonChoixAdversaire = caillouA;
  ...
  public void update(Observable o, Object obj) {
    ...
    nombrePointsAdversaire.setText(
      Integer.toString(joueur.adversaire.nbPoints)
    );
    indiquerChoixAdversaire();
    if (joueur.partieGagnee) {
      ...
      if (boutonChoixAdversaire != null) boutonChoixAdversaire.setBackground(
        couleurBouton
      );
    }
  }
